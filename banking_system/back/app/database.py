...
# database instance
app.config['SQLALCHEMY_DATABASE_URI'] = "mysql://des0116:0116@localhost/bank"
...
# start attributes
    lp_Serialnumber = db.Column(db.String(CODE_LEN), primary_key=True)
...
# end attributes
    ...
    def __init__(self, lp_Serialnumber, lp_date, lp_money, lp_l_code):
        self.lp_Serialnumber = lp_Serialnumber
