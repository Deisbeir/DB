...
create table loan_customer(
    ...
    constraint FK_LCLLC foreign key (lc_l_code) references loan(l_code) On Delete Cascade,
...
INSERT INTO sub_bank values('Urumqi Bank', 'Urumqi', 0.0);
INSERT INTO sub_bank values('Altay Bank', 'Altay', 0.0);
...
INSERT INTO staff values('staff_1', 'staffA', '18512312345', '合肥市蜀山区', '2012-01-11', 'depart_1');
INSERT INTO staff values('staff_2', 'staffB', '18732332333', '合肥市包河区', '2014-01-10', 'depart_1');
INSERT INTO staff values('staff_3', 'staffC', '18823311451', '北京市昌平区', '2016-06-01', 'depart_3');
INSERT INTO staff values('staff_4', 'staffD', '13344455555', '北京市海淀区', '2016-11-24', 'depart_4');
INSERT INTO staff values('staff_5', 'staffE', '18912345678', '北京市朝阳区', '2018-02-02', 'depart_5');
INSERT INTO staff values('staff_6', 'staffF', '15912345678', '上海市浦东区', '2020-07-04', 'depart_2');
INSERT INTO staff values('staff_7', 'staffG', '18900011100', '乌鲁木齐市天山区', '2021-02-24', 'depart_3');
INSERT INTO staff values('staff_8', 'staffH', '18912321232', '阿勒泰市富蕴县', '2021-06-03', 'depart_6');

INSERT INTO manager values('staff_1', 'depart_1');
INSERT INTO manager values('staff_3', 'depart_2');
INSERT INTO manager values('staff_6', 'depart_3');
INSERT INTO manager values('staff_4', 'depart_4');
INSERT INTO manager values('staff_7', 'depart_5');
...
UPDATE department SET d_m_identity_code = 'staff_3' WHERE d_code = 'depart_2';
UPDATE department SET d_sb_name = 'Beijing Bank' WHERE d_code = 'depart_2';
UPDATE department SET d_m_identity_code = 'staff_6' WHERE d_code = 'depart_3';
...
UPDATE department SET d_sb_name = 'Urumqi Bank' WHERE d_code = 'depart_4';
UPDATE department SET d_m_identity_code = 'staff_7' WHERE d_code = 'depart_5';
...
UPDATE department SET d_sb_name = 'Altay Bank' WHERE d_code = 'depart_6';